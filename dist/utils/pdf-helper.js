...
exports.encryptPdfBuffer = void 0;
 ...
 */
const encryptPdfBuffer = async (inputBuffer) => {
    // 1. Create a readable stream from the input buffer
    const inputStream = new muhammara_1.default.PDFRStreamForBuffer(inputBuffer);
    // 2. Create a writable stream for the output
    const outputStream = new muhammara_1.default.PDFWStreamForBuffer();
    try {
        // 3. Recrypt the document with the required security settings
        // Note: userPassword is what the client uses to open the file.
        muhammara_1.default.recrypt(inputStream, outputStream, {
...
exports.encryptPdfBuffer = encryptPdfBuffer;
